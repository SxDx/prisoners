...
public class PerKindPrisoner extends Prisoner {

    private ArrayList<MessageType> messages = new ArrayList<MessageType>(Arrays.asList(MessageType.Cooperate, MessageType.Cooperate, MessageType.Defect));
    private int index = 0;
